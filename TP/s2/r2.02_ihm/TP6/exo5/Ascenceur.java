...
public class Ascenceur extends Frame implements AdjustmentListener, ActionListener
{
	...
	public Ascenceur()
	{
		...
		/*-----------------------------*/
		this.lblDroite = new Label("FF");
		this.lblGauche = new Label("00");
		
		this.sbDefil1 = new Scrollbar ( Scrollbar.HORIZONTAL,0,10,0,300+10);
