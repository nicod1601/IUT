...
public class TestLinkedList
{
    ...
    {
        Queue<Etudiant> lstEtudiant;
        lstEtudiant = new LinkedList<Etudiant>();
    
        lstEtudiant = new ArrayList<Etudiant>();

        System.out.println(lstEtudiant);
        lstEtudiant.add(new Etudiant("Menvussa","Gérard",12));
        System.out.println(lstEtudiant.remove());
        ...
        System.out.println(lstEtudiant);
        lstEtudiant.add(new Etudiant("Jacques" ,"Ouzzi" ,15));
        System.out.println(lstEtudiant.remove());
